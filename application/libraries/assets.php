...
class Assets {
	...
	private static function _paths()
	{
		...
		//central cache path and url
		self::$cache_path = reduce_double_slashes(realpath(self::$cache_dir));
		self::$cache_url  = $slash.reduce_double_slashes(reduce_double_slashes(config_item('base_url').'/'.self::$cache_dir));
